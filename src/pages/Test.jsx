      ...
      <header id="header" className="site-header">
        <div className="container">
          <div className="site-brand">
            <a href="index.html">
              <img src={require('src/images/assets/logo.png')} alt="" />
            </a>
          </div>
                    ...
                    <div className="staff-picks-author">
                      <div className="author-profile">
                        <a className="author-avatar" href="#">
                          <img src={require('src/images/placeholder/40x40.png')} alt="" />
                        </a>
                        by{' '}
                        <a className="author-name" href="#">
                          Andrew Noah
                ...
                <div className="col-lg-4 col-sm-6">
                  <div className="campaign-item">
                    ...
                    <div className="campaign-box">
                      ...
                      <div className="campaign-description">
                        A watch designed to be an heirloom to be passed down to the next generation.
                      </div>
                      <div className="campaign-author">
                        <a className="author-icon" href="#">
                          <img src={require('src/images/placeholder/35x35.png')} alt="" />
        ...
        <div className="partners">
          <div className="container">
            <div className="partners-slider owl-carousel">
              <div>
                <a href="#">
                  <img src={require('src/images/partner-01.png')} alt="" />
                </a>
              </div>
              <div>
                <a href="#">
                  <img src={require('src/images/partner-02.png')} alt="" />
                </a>
              </div>
              <div>
                <a href="#">
                  <img src={require('src/images/partner-03.png')} alt="" />
                </a>
              </div>
              <div>
                <a href="#">
                  <img src={require('src/images/partner-04.png')} alt="" />
                </a>
              </div>
              <div>
                <a href="#">
                  <img src={require('src/images/partner-05.png')} alt="" />
                </a>
              </div>
              <div>
                <a href="#">
                  <img src={require('src/images/partner-06.png')} alt="" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-3 col-sm-12 col-12">
                <div className="footer-menu-item newsletter">
                  <h3>Newsletter</h3>
                  <div className="newsletter-description">Private, secure, spam-free</div>
                  <form action="s" method="POST" id="newsletterForm">
                    <input type="text" value="" name="s" placeholder="Enter your email..." />
                    <button type="submit" value="">
                      <span className="ion-android-drafts"></span>
                    </button>
                  </form>
            ...
            <div className="footer-top">
              <p className="payment-img">
                <img src={require('src/images/assets/payment-methods.png')} alt="" />
              </p>
              <div className="footer-top-right">
                <div className="dropdow field-select">
                  <select name="s">
