            ...
            <div className="campaign-item clearfix">
              ...
              <div className="campaign-box">
                ...
                <div className="campaign-description">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam tempor, ipsum ut
                    mattis commodo, eros justo feugiat ante, sed tristique erat urna et nibh. Donec
                    nec rhoncus mi, non laoreet tortor. Proin ullamcorper ipsum interdum tellus
                    scelerisque, a ultricies urna vehicula. Mauris faucibus metus quis commodo
                    pharetra.
                  </p>
                </div>
                ...
                <div className="share">
                  ...
                  <ul>
                    ...
                    <li className="share-google-plus">
                      <Link to="/">
                ...
                <div className="campaign-content">
                  <div id="campaign" className="tabs active">
                    <p>
                      ...
                      exercitation ullamco laboris. Ut enim ad minim veniam, quis nostrud
                  ...
                  <div id="updates" className="tabs">
                    <ul>
                      <li>
                        ...
                        <div className="desc">
                          <p>
                            ...
                            tongue kielbasa, boudin hamburger t-bone capicola turducken. Landjaeger
                      ...
                      <li>
                        ...
                        <div className="desc">
                          <p>
                            Corned beef leberkas fatback porchetta, strip steak salami turkey short
                            loin flank ham hock landjaeger. Leberkas pork belly kevin shoulder filet
                            mignon. Bacon spare ribs rump chuck turkey, ham hock capicola. Strip
                            steak tongue kielbasa, boudin hamburger t-bone capicola turducken.
                      ...
                      <li>
                        ...
                        <div className="desc">
                          <p>
                            ...
                            sagittis dolor, quis maximus magna consectetur eu. Cras pharetra aliquam
                            fringilla. Integer placerat sapien dapibus varius luctus. Lorem ipsum
                            dolor sit amet, consectetur adipiscing elit. Vestibulum in aliquam urna,
                            ultrices lobortis lacus. Praesent mi enim, congue semper volutpat ut,
                            bibendum tempor arcu.
                          </p>
                        </div>
                      </li>
                    </ul>
                          ...
                          <div className="comment-info">
                            ...
                            <div className="comment-content">
                              <p>
                                ...
                                Cn. Sequitur disserendi ratio cognitioque naturae; Nunc vides, quid
                                faciat. Duo Reges: constructio interrete. Memini vero, inquam; Quis
